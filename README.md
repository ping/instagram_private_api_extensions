...
[![Release](https://img.shields.io/badge/release-v0.2.3-orange.svg)](https://github.com/ping/instagram_private_api_extensions/releases)
...
```bash
pip install git+ssh://git@github.com/ping/instagram_private_api_extensions.git@0.2.3
```

To update:

```bash
pip install git+ssh://git@github.com/ping/instagram_private_api_extensions.git@0.2.3 --upgrade
```
