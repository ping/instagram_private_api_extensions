...
MPD_CONTENT_MULTIPERIODS = '''<?xml version="1.0" ?>
<MPD maxSegmentDuration="PT0H0M2.000S" mediaPresentationDuration="PT0H0M10.004S" minBufferTime="PT1.500S" profiles="urn:mpeg:dash:profile:isoff-on-demand:2011,http://dashif.org/guidelines/dash264" type="static"
    xmlns="urn:mpeg:dash:schema:mpd:2011">
    <Period duration="PT0H0M5.002S">
        <AdaptationSet lang="und" segmentAlignment="true" subsegmentAlignment="true" subsegmentStartsWithSAP="1">
            <Representation audioSamplingRate="44100" bandwidth="50598" codecs="mp4a.40.2" id="1" mimeType="audio/mp4" startWithSAP="1">
